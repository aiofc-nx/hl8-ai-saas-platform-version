...
export class AuditTrail extends ValueObjectBase<AuditTrailProps> {
  ...
  public static create(initial: { createdBy?: UserId | null; updatedBy?: UserId | null }): AuditTrail {
...
export class SoftDeleteStatus extends ValueObjectBase<SoftDeleteProps> {
  ...
  public static create(initial?: { isDeleted?: boolean; deletedAt?: DateTimeValueObject | null; deletedBy?: UserId | null }): SoftDeleteStatus {
