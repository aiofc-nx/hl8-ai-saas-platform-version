...
`@hl8/domain-core` 提供聚合根、实体、值对象、领域事件与守卫工具等领域层基线能力，支撑多租户 SaaS 平台快速构建一致的领域模型。
...
```ts
import { AggregateId, AggregateRootBase, TenantId, AuditTrail, SoftDeleteStatus } from "@hl8/domain-core";
